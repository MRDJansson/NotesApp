...
function MainBody() {
  return (
    <div className="flex flex-col items-center justify-center space-y-6 p-6 py-10 bg-white rounded-lg shadow-md mx-auto max-w-4xl ">
      <div className="text-center space-y-4 px-4">
        <h2 className="text-2xl font-bold text-gray-800">Welcome to NotesApp!</h2>
